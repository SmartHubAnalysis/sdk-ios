...
+ (void)startWithConfigOptions:(SAConfigOptions *)configOptions debugMode:(SendataAnalyticsDebugMode)debugMode {
    ...
    if ([SAModuleManager.sharedInstance contains:SAModuleTypeAutoTrack] || configOptions.autoTrackEventType != SendataAnalyticsEventTypeNone) {
