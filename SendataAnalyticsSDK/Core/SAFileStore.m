...
#if TARGET_OS_OSX
    // 兼容老版 mac SDK 的本地数据
    NSString *filename = [NSString stringWithFormat:@"com.sendata.analytics.mini.SendataAnalyticsSDK.%@.plist", key];
#else
    NSString *filename = [NSString stringWithFormat:@"sendataanalytics-%@.plist", key];
#endif
