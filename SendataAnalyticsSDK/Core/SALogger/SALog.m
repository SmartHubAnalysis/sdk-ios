...
+ (instancetype)sharedLog {
    ...
    dispatch_once(&onceToken, ^{
        ...
        logConcurrentQueue = dispatch_queue_create("cn.sendata.SALogConcurrentQueue", DISPATCH_QUEUE_CONCURRENT);
        logSerialQueue = dispatch_queue_create("cn.sendata.SALogSerialQueue", DISPATCH_QUEUE_SERIAL);
