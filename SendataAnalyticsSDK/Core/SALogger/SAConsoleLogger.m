...
@property (nonatomic, copy, readonly) NSString *sendata_unicodeString;
@end

@implementation NSString (Unicode)

- (NSString *)sendata_unicodeString {
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.loggerQueue = dispatch_queue_create("cn.sendata.SAConsoleLoggerSerialQueue", DISPATCH_QUEUE_SERIAL);
    }
    return self;
}
...
- (void)logMessage:(SALogMessage *)logMessage {
    ...
    NSString *message = [formatter formattedLogMessage:logMessage].sendata_unicodeString;
