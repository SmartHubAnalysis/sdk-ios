 ...
 */
@interface SendataAnalyticsSDK : NSObject
 ...
 */
@property (atomic, readonly, strong) SendataAnalyticsPeople *people;
...
@interface SendataAnalyticsSDK (Deeplink)
...
#pragma mark - JSCall
@interface SendataAnalyticsSDK (JSCall)
 ...
 */
@interface SendataAnalyticsPeople : NSObject
...
@interface SendataAnalyticsSDK (Deprecated)
 ...
 *
 ...
 @return 返回的单例
 */
+ (SendataAnalyticsSDK *)sharedInstanceWithConfig:(nonnull SAConfigOptions *)configOptions __attribute__((deprecated("已过时，请使用 + (void)startWithConfigOptions: 方法进行初始化")));
 ...
 * @return 返回的单例
 */
+ (SendataAnalyticsSDK *)sharedInstanceWithServerURL:(nullable NSString *)serverURL
                                        andDebugMode:(SendataAnalyticsDebugMode)debugMode __attribute__((deprecated("已过时，请参考 sharedInstanceWithConfig:"))) API_UNAVAILABLE(macos);
 ...
 */
- (void)setDebugMode:(SendataAnalyticsDebugMode)debugMode __attribute__((deprecated("已过时，建议动态开启调试模式"))) API_UNAVAILABLE(macos);
 ...
 */
- (void)trackTimerBegin:(NSString *)event withTimeUnit:(SendataAnalyticsTimeUnit)timeUnit __attribute__((deprecated("已过时，请参考 trackTimerStart")));
 ...
 * @param timeUnit          计时单位，毫秒/秒/分钟/小时
 */
- (void)trackTimer:(NSString *)event withTimeUnit:(SendataAnalyticsTimeUnit)timeUnit __attribute__((deprecated("已过时，请参考 trackTimerStart")));
