...
- (void)handleUncaughtException:(NSException *)exception {
    ...
    @try {
        ...
        sendata_dispatch_safe_sync(SendataAnalyticsSDK.sdkInstance.serialQueue, ^{});
        SALogError(@"Encountered an uncaught exception. All SendataAnalytics instances were archived.");
