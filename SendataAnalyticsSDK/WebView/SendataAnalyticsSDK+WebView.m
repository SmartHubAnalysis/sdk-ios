...
#if __has_include("SendataAnalyticsSDK+WKWebView.h")
#error This file cannot exist at the same time with `SendataAnalyticsSDK+WKWebView.h`. If you use `UIWebView`, please delete it.
#endif

#import "SendataAnalyticsSDK+WebView.h"
...
@interface SendataAnalyticsSDK (SAWebViewPrivate)
...
@implementation SendataAnalyticsSDK (WebView)
