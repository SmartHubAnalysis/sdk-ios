...
typedef NS_ENUM(NSInteger, SendataAnalyticsVisualizedType) {
      SendataAnalyticsVisualizedTypeUnknown,  // 未知或不允许
    SendataAnalyticsVisualizedTypeHeatMap, // 点击图
      SendataAnalyticsVisualizedTypeAutoTrack  //可视化全埋点
};
...
/// 当前连接类型
@property (nonatomic, assign, readonly) SendataAnalyticsVisualizedType visualizedType;
