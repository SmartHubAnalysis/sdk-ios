...
- (instancetype)initWithView:(UIView *)view {
    self = [super init];
    if (self) {
        _elementPath = view.sendata_elementPath;
        _screenName = view.sendata_screenName;
        _elementContent = view.sendata_elementContent;
        _elementPosition = view.sendata_elementPosition;
...
- (instancetype)initWithDictionary:(NSDictionary *)eventsDic {
    ...
    if (self) {
        ...
        if ([eventTypeString isEqualToString:@"appclick"]) {
            _eventType =   SendataAnalyticsEventTypeAppClick;
        } else {
            _eventType = SendataAnalyticsEventTypeNone;
        }
