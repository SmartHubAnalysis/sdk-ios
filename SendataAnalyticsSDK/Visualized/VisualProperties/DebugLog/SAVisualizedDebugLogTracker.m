...
- (instancetype)init {
    self = [super init];
    if (self) {
        NSString *serialQueueLabel = [NSString stringWithFormat:@"com.sendata.SAVisualizedDebugLogTracker.%p", self];
...
- (void)addAllNodeInfo {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        SAViewNode *rootNode = keyWindow.sendata_viewNode.nextNode;
