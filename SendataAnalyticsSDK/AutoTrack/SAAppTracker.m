...
- (NSDictionary *)autoTrackViewControllerBlackList {
    ...
    dispatch_once(&onceToken, ^{
        NSBundle *sendataBundle = [NSBundle bundleWithPath:[[NSBundle bundleForClass:[SendataAnalyticsSDK class]] pathForResource:@"SendataAnalyticsSDK" ofType:@"bundle"]];
        //文件路径
        NSString *jsonPath = [sendataBundle pathForResource:@"sa_autotrack_viewcontroller_blacklist.json" ofType:nil];
