...
- (void)sendata_setDelegate:(id <UITableViewDelegate>)delegate {
    ...
    if ([SAAutoTrackManager.sharedInstance isAutoTrackEventTypeIgnored:SendataAnalyticsEventTypeAppClick]) {
        return;
    }
...
- (void)sendata_setDelegate:(id <UICollectionViewDelegate>)delegate {
    //resolve optional selectors
    [SAScrollViewDelegateProxy resolveOptionalSelectorsForDelegate:delegate];
