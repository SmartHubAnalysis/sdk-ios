...
@property (nonatomic, strong) NSMutableArray <SAGestureTargetActionModel *>*sendata_targetActionModels;
@property (nonatomic, strong) SAGestureTarget *sendata_gestureTarget;
