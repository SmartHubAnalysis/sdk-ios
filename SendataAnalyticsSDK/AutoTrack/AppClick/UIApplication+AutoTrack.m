...
- (BOOL)sa_sendAction:(SEL)action to:(id)to from:(id)from forEvent:(UIEvent *)event {
     ...
     */
    BOOL sendataAnalyticsAutoTrackAfterSendAction = [from isKindOfClass:[UIView class]] && [(UIView *)from sendataAnalyticsAutoTrackAfterSendAction];
    BOOL autoTrackAfterSendAction = isTabBar || sendataAnalyticsAutoTrackAfterSendAction;
